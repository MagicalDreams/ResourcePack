...
- `magicaldreams:magicband` is referenced by `minecraft:default`. U+E7A0 advances −8 pixels; U+E7A1 and U+E7A3 render the left and right halves at height 126/ascent 13. Each source cell is 176×252, within Minecraft’s 256×256 glyph-atlas limit. Insert U+E7A4 (−1 pixel) between them to cancel the first glyph’s extra advance, then U+E7A2 (−169 pixels) to restore the title origin. The sequence is E7A0, E7A1, E7A4, E7A3, E7A2. The plugin renders the panel white before applying the player's chosen title color.
